...
export default function Home() {
  const CONTRACT_ADDRESS = "0x98c62B6100731C5302F77CF4F87A162a7AB3f5a9";
    ...
    <>
      ...
      <main className={styles.main}>
        <div className={styles.description}>
          <div>
            <h1 className={inter.className}>Poucherr</h1>
          </div>
        </div>

        <div className={styles.center}>
          <div>
            <Image src="/preview.png" alt="Preview" width={300} height={478} />
          </div>
          <div>
            {currentAccount === "" ? (
        ...
        <div>
          <a
            href="https://testnets.opensea.io/collection/squarenft-davfznmdae"
          ...
          >
            ...
            <p className={inter.className}>Limited to 50 invites</p>
          </a>
        </div>
      </main>
    </>
